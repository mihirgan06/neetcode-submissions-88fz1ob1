class Solution:
    def productExceptSelf(self, nums: List[int]) -> List[int]:
        '''
            ...
            Approach:
                initialize a running prefix and postfix sum
                create a res array of size n
                Loop through n 
                Initially update prefix to multiply by every num up to i

                loop backwards to calculate postfix
                update postfix to multiply by nums[i]
            '''
        n = len(nums)
