class Solution:
    def canFinish(self, numCourses: int, prerequisites: List[List[int]]) -> bool:
        ...
        def dfs(course):
            #2 base cases:
                #first if we already visited the course return False
                #second if there are no prereqs then return true
            ...
            #run dfs on all prereqs and return false if we get false from any of the prereqs
