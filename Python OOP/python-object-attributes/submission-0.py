...
print(f"Initial Attributes: {whiskers.name} - Hunger: {whiskers.hunger}, Energy: {whiskers.energy}")
whiskers.hunger -= 3
whiskers.energy += 2
print(f"Modified Attributes: {whiskers.name} - Hunger: {whiskers.hunger}, Energy: {whiskers.energy}")
